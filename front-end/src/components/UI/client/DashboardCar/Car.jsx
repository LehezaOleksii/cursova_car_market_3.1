            ...
            <div className="mt-3 d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex">
                <Link to={`/car/${car.id}`} className="dropdown-item">
                  <button className="btn btn-blue-color btn-primary   br24" style={{marginRight:"12px"}}>Details</button>
                </Link>
                <div className="dropdown-item">
                  <button className="btn btn-blue-color btn-primary br24" onClick={handleSendMessage}>
