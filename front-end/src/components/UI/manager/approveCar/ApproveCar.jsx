        ...
        <div className="col-md-7">
          <div className="card-body">
            ...
            <div className="mt-3 d-flex align-items-center gap-2 flex-wrap mt-4">
              <p className="card-text mb-0 d-flex align-items-center gap-2" style={{ flex: 1 }}>
                {`Views ${car.views} `}
              ...
              <div className="d-flex align-items-center gap-2" style={{ marginLeft: "auto" }}>
                {car.status === "ON_MODERATION" ? (
                  <>
                    ...
                    <button className="btn   btn-primary br24" style={{ padding: "7px", width: "110px" }} onClick={approveCar}>
                      Approve Car
                    </button>
                    <button className="btn btn-danger br24" onClick={blockCar} style={{ padding: "7px", width: "130px" }}>
                      Disapprove Car
                    </button>
                  </>
                ) : (
                  <>
                    ...
                    <button onClick={handleNavigate} className="btn btn-primary br24" style={{ padding: "7px", width: "195px" }}>
                      Change Car Information
                    </button>
                    <button className="btn btn-danger br24" style={{ padding: "7px", width: "105px" }} onClick={() => setShowConfirm(true)}>
                      Remove Car
                    </button>
                  </>
                )}
