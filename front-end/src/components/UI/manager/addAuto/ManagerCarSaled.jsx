...
const ManagerCarSaleCard = ({ car, removeCarFromList }) => {
  ...
  const handleRemoveCarSubmit = async (carId) => {
    const url = `http://localhost:8080/managers/${managerId}/vehicles/${carId}/remove`;
    await fetch(url, {
      method: 'DELETE',
      headers: {
...
<div className="col-md-8">
  <div className="card-body">
    ...
    <div className="d-flex justify-content-end mt-3">
              <Link to={`/manager/${managerId}/change_auto/${carId}`} className="btn btn-primary me-2">
...
export default ManagerCarSaleCard;
