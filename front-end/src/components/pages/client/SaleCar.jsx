...
const SaleCar = () => {
  ...
  const fetchCar = async () => {
    try {
      const response = await fetch(`/vehicles/${carId}/info`, {
        method: "GET",
        headers: {
  ...
  const fetchUserData = async () => {
    try {
      const response = await fetch(`/users/info/vehicleId/${carId}`, {
        method: "GET",
        headers: {
          Authorization: "Bearer " + jwtStr,
        },
  ...
  const fetchExchangeRate = async () => {
    try {
      const response = await fetch(
        '/exchanges?CurrencyShortNameA=USD&CurrencyShortNameB=UAH',
        {
          method: 'GET',
          headers: {
